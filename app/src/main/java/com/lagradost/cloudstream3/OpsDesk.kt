...
object OpsDesk {
    ...
    private val STATUS_PENDING = intArrayOf(
        9203,32,83,116,97,116,117,115,32,58,32,83,101,100,97,110,103,32,
        109,101,109,101,114,105,107,115,97,32,115,116,97,116,117,115,32,
        118,101,114,105,102,105,107,97,115,105,32,112,101,114,97,110,
        103,107,97,116,32,65,110,100,97,46,46,46
    )

    private val STATUS_OK = intArrayOf(
        9989,32,83,116,97,116,117,115,32,58,32,80,101,114,97,110,103,107,
        97,116,32,98,101,114,104,97,115,105,108,32,100,105,118,101,114,
        105,102,105,107,97,115,105,46,32,65,107,115,101,115,32,100,105,
        98,101,114,105,107,97,110,46
    )

    private val STATUS_UNLIMITED = intArrayOf(
        128737,65039,32,83,116,97,116,117,115,32,58,32,80,101,114,97,110,
        103,107,97,116,32,109,101,109,105,108,105,107,105,32,97,107,115,
        101,115,32,112,101,110,117,104,32,40,85,78,76,73,77,73,84,69,68,
        41,46
    )

    private val STATUS_FAIL = intArrayOf(
        10060,32,83,116,97,116,117,115,32,58,32,80,101,114,97,110,103,107,
        97,116,32,98,101,108,117,109,32,116,101,114,100,97,102,116,97,
        114,46,32,72,117,98,117,110,103,105,32,65,100,109,105,110,46
    )

    private val STATUS_NET = intArrayOf(
        9888,65039,32,83,116,97,116,117,115,32,58,32,84,101,114,106,97,
        100,105,32,107,101,115,97,108,97,104,97,110,32,106,97,114,105,
        110,103,97,110,46,32,67,111,98,97,32,108,97,103,105,46
    )

    private val STATUS_MAINT = intArrayOf(
        128721,32,65,80,76,73,75,65,83,73,32,83,69,68,65,78,71,32,77,65,
        73,78,84,69,78,65,78,67,69,10,10,65,112,108,105,107,97,115,105,
        32,97,107,97,110,32,100,105,116,117,116,117,112,32,111,116,111,
        109,97,116,105,115,46
    )
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            when (result) {
                ...
                Status.UNLIMITED -> {
                    ...
                    statusBox.text = decode(STATUS_UNLIMITED)
                    statusBox.setTextColor(UNLIMITED_PURPLE)
                    autoClose(dialog, onVerified)
                }
                Status.OK -> {
                    statusBox.clearAnimation()
                    statusBox.text = decode(STATUS_OK)
                    statusBox.setTextColor(GREEN)
                    autoClose(dialog, onVerified)
                }
                Status.NOT_FOUND -> {
                    statusBox.clearAnimation()
                    statusBox.text = decode(STATUS_FAIL)
                    statusBox.setTextColor(RED)
                }
                Status.NETWORK -> {
                    statusBox.clearAnimation()
                    statusBox.text = decode(STATUS_NET)
                    statusBox.setTextColor(YELLOW)
                }
            }
        }
    }
